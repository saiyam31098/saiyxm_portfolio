        ...
        <div class="body__class">
            ...
            <div class="timeline">
                <div class="container right">
                    ...
                    <div class="content">
                    <center><img src={AKAM_LOGO} style={{ height: '25%', width: '25%' }}></img></center>
                ...
                <div class="container left">
                    ...
                    <div class="content">
                        ...
                        <center><p> Build and develop complex and critical solutions by collaborating with cross-functional teams including developers, testers, designers and Program Managers. 
                ...
                <div class="container right">
                    ...
                    <i class="icon"><FaLaptopCode /></i>
                    <div class="content">
                        <center><img src={CAPG_LOGO} style={{ height: '60%', width: '60%' }}></img></center>
